...
/**
 * this class is needed to fill the tableview in GUIfirsttry. Every row there is
 * one of this class( with the 4 variables) Four variables here means for
 * columns there
 * 
...
public class TableData {
	 ...
	 * 
	 * @param drink
	 *            used for naming the drink
	 * @param showr
	 *            amount of the drink in the show room
	 * @param storer1
	 *            amount of the drink in the store room 1
	 * @param storer2
	 *            amount of the drink in the store room 2
	 */
	 ...
	 * 
	 * @param showr
	 *            the amount of drinks, to which showr will be set
	 */
